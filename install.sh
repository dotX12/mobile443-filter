...
#  mobile443 installer
#  Использование:
#    bash <(curl -Ls https://raw.githubusercontent.com/dotX12/mobile443-filter/refs/heads/main/install.sh)
#    bash <(curl -Ls https://raw.githubusercontent.com/dotX12/mobile443-filter/refs/heads/main/install.sh) update
#    bash <(curl -Ls https://raw.githubusercontent.com/dotX12/mobile443-filter/refs/heads/main/install.sh) remove
# ═══════════════════════════════════════════════════════════
set -Eeuo pipefail
